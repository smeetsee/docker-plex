...
RUN chown -R plex:plex /etc/services.d/plex && chmod -R 0644 /etc/services.d/plex
...
ENTRYPOINT ["/bin/sh", "-c", "mkdir -p /tmp/run && mkdir -p /home/container/config && mkdir -p /home/container/transcode && chown container:container /home/container/config && chown container:container /home/container/transcode && /init"]
